...
def get_filter_options(filters):
    ...
    return {
        ...
        "labels": to_json(DataProvider().labels(
            album_uris=album_uris,
            artist_uris=artist_uris,
            playlist_uris=playlist_uris,
            liked=liked
        )[['album_standardized_label']], 'album_standardized_label')
    }


array_filter_keys = ["artists", "albums", "playlists", "labels"]
