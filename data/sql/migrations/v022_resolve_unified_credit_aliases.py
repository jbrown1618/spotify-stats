...
from data.sql.migrations.v021_add_unified_track_credits import (
    create_unified_track_credits,
)


resolve_unified_credit_aliases = """
...
class ResolveUnifiedCreditAliases(Migration):
    def __init__(self):
        super().__init__("v22")

    def migrate(self, cursor):
        cursor.execute(resolve_unified_credit_aliases)
...
if __name__ == "__main__":
    ResolveUnifiedCreditAliases().perform_migration()
