...
def albums_table(tracks: pd.DataFrame):
    ...
    grouped = grouped.rename(columns={"track_uri": "Number of Tracks", "album_name": "Album", "album_release_date": "Release Date"})
    ...
    table_data = grouped[["Number of Tracks", "Art", "Album", "Release Date", "🔗"]]
